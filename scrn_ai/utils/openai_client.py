...
Respond ONLY with valid JSON, no additional text."""
    ...
    def predict_cell_type(
        ...
        """
        prompt = self._build_cell_type_prompt(marker_genes, cluster_id, species, tissue, context)
            ...
            try:
                ...
                response = self.client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "You are an expert in single-cell biology and cell type identification.",
                        },
                ...
                logger.warning(
                    "Failed to parse JSON response (attempt %d/%d)", attempt + 1, self.max_retries
                )
